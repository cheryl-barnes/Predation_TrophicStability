# This script file includes code necessary to an calculate index of predation for Walleye Pollock in the Gulf of Alaska (MT per year; 1990 to 2015). Pollock predator: Pacific Cod (Gadus macrocephalus). 
...
PCpredationWEP$NormAbun = 1 # time-varying index = basin-wide scale
#########################################################
