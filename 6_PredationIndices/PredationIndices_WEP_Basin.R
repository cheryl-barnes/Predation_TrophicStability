# This script file includes code necessary to calculate an index of predation for Walleye Pollock in the Gulf of Alaska (MT per year; 1990 to 2015). Pollock predator: Walleye Pollock (Gadus chalcogrammus) conspecifics. 
...
WEPpredationWEP$NormAbun = 1 # time-varying index = basin-wide scale
#########################################################
