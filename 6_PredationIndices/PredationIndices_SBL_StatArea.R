# This script file includes code necessary to calculate statistical area indices of predation for Walleye Pollock in the Gulf of Alaska (MT per year; 1990 to 2015). Pollock predator: Sablefish (Anoplopoma fimbria). 
...
# Eliminate locations outside of the study area:  
Ration_SBL$StatArea = as.factor(Ration_SBL$StatArea)
Ration_SBL = subset(Ration_SBL, StatArea != "Other")
Ration_SBL$StatArea = ordered(Ration_SBL$StatArea, levels=c("Shumagin", "Chirikof", "Kodiak", "Yakutat", "Southeastern"))
...
Shum93 = subset(Ration_SBL_Cmax, Year == 1993 & StatArea == "Shumagin")
Ration_SBL_Cmax = as.data.frame(Ration_SBL_Cmax)
Ration_SBL_Cmax = add_row(Ration_SBL_Cmax)
Ration_SBL_Cmax[nrow(Ration_SBL_Cmax), ] = c(1990, "Shumagin", Shum93[1,3])

# Assume that the mean annual rations in 2013 and 2015 (missing Sablefish data) were the same as in 2011:

# Shumagin:
Ration_SBL_Cmax = as.data.frame(Ration_SBL_Cmax)
Shum11 = subset(Ration_SBL_Cmax, Year == 2011 & StatArea == "Shumagin")
Ration_SBL_Cmax = add_row(Ration_SBL_Cmax)
Ration_SBL_Cmax[nrow(Ration_SBL_Cmax), ] = c(2013, "Shumagin", Shum11[1,3])
Ration_SBL_Cmax = add_row(Ration_SBL_Cmax)
Ration_SBL_Cmax[nrow(Ration_SBL_Cmax), ] = c(2015, "Shumagin", Shum11[1,3])

# Chirikof:
Ration_SBL_Cmax = as.data.frame(Ration_SBL_Cmax)
Chir11 = subset(Ration_SBL_Cmax, Year == 2011 & StatArea == "Chirikof")
Ration_SBL_Cmax = add_row(Ration_SBL_Cmax)
Ration_SBL_Cmax[nrow(Ration_SBL_Cmax), ] = c(2013, "Chirikof", Chir11[1,3])
Ration_SBL_Cmax = add_row(Ration_SBL_Cmax)
Ration_SBL_Cmax[nrow(Ration_SBL_Cmax), ] = c(2015, "Chirikof", Chir11[1,3])

# Kodiak:
Ration_SBL_Cmax = as.data.frame(Ration_SBL_Cmax)
Kod11 = subset(Ration_SBL_Cmax, Year == 2011 & StatArea == "Kodiak")
Ration_SBL_Cmax = add_row(Ration_SBL_Cmax)
Ration_SBL_Cmax[nrow(Ration_SBL_Cmax), ] = c(2013, "Kodiak", Kod11[1,3])
Ration_SBL_Cmax = add_row(Ration_SBL_Cmax)
Ration_SBL_Cmax[nrow(Ration_SBL_Cmax), ] = c(2015, "Kodiak", Kod11[1,3])

# Yakutat:
Ration_SBL_Cmax = as.data.frame(Ration_SBL_Cmax)
Yak11 = subset(Ration_SBL_Cmax, Year == 2011 & StatArea == "Yakutat")
Ration_SBL_Cmax = add_row(Ration_SBL_Cmax)
Ration_SBL_Cmax[nrow(Ration_SBL_Cmax), ] = c(2013, "Yakutat", Yak11[1,3])
Ration_SBL_Cmax = add_row(Ration_SBL_Cmax)
Ration_SBL_Cmax[nrow(Ration_SBL_Cmax), ] = c(2015, "Yakutat", Yak11[1,3])

# Southeastern:
Ration_SBL_Cmax = as.data.frame(Ration_SBL_Cmax)
SE11 = subset(Ration_SBL_Cmax, Year == 2011 & StatArea == "Southeastern")
Ration_SBL_Cmax = add_row(Ration_SBL_Cmax)
Ration_SBL_Cmax[nrow(Ration_SBL_Cmax), ] = c(2013, "Southeastern", SE11[1,3])
Ration_SBL_Cmax = add_row(Ration_SBL_Cmax)
Ration_SBL_Cmax[nrow(Ration_SBL_Cmax), ] = c(2015, "Southeastern", SE11[1,3])

# Assume that the mean annual ration in Yakutat in 2003 was the same as the area-specific mean:
Ration_Yak03 = Ration_SBL %>%
  group_by(StatArea) %>%
  summarise(Annual_Cmax = mean(Cmax_ggy, na.rm=TRUE))
Ration_Yak03 = subset(Ration_Yak03, StatArea == "Yakutat")
Ration_SBL_Cmax = add_row(Ration_SBL_Cmax)
Ration_SBL_Cmax[nrow(Ration_SBL_Cmax), ] = c(2003, "Yakutat", Ration_Yak03[1,2])
...
# Eliminate locations outside of the study area: 
propWEP_SBL$StatArea = as.factor(propWEP_SBL$StatArea)
propWEP_SBL = subset(propWEP_SBL, StatArea != "Other")
propWEP_SBL$StatArea = ordered(propWEP_SBL$StatArea, levels=c("Shumagin", "Chirikof", "Kodiak", "Yakutat", "Southeastern"))
...
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(1990, "Shumagin", "Gadus.chalcogrammus", 0, 0)
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(1999, "Shumagin", "Gadus.chalcogrammus", 0, 0)
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2003, "Shumagin", "Gadus.chalcogrammus", 0, 0)
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2007, "Shumagin", "Gadus.chalcogrammus", 0, 0)
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2009, "Shumagin", "Gadus.chalcogrammus", 0, 0)
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2011, "Shumagin", "Gadus.chalcogrammus", 0, 0)
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2009, "Chirikof", "Gadus.chalcogrammus", 0, 0)
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2011, "Chirikof", "Gadus.chalcogrammus", 0, 0)
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2005, "Kodiak", "Gadus.chalcogrammus", 0, 0)
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2005, "Yakutat", "Gadus.chalcogrammus", 0, 0)
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2003, "Yakutat", "Gadus.chalcogrammus", 0, 0)
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2007, "Yakutat", "Gadus.chalcogrammus", 0, 0)
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2009, "Yakutat", "Gadus.chalcogrammus", 0, 0)
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2011, "Yakutat", "Gadus.chalcogrammus", 0, 0)
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2005, "Southeastern", "Gadus.chalcogrammus", 0, 0)
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2007, "Southeastern", "Gadus.chalcogrammus", 0, 0)
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2009, "Southeastern", "Gadus.chalcogrammus", 0, 0)
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2011, "Southeastern", "Gadus.chalcogrammus", 0, 0)

# Assume proportions of pollock consumed in 2013 and 2015 (and Chirikof in 1996 and in Kodiak in 1996, 1999, 2003) were equal to area-specific means:
propWEP_SBLsub = as.data.frame(propWEP_SBLsub)
propWEP_SBLsub$propWT = as.numeric(propWEP_SBLsub$propWT)
ShumProp = subset(propWEP_SBLsub, StatArea == "Shumagin")
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2013, "Shumagin", "Gadus.chalcogrammus", NA, mean(ShumProp$propWT))
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2015, "Shumagin", "Gadus.chalcogrammus", NA, mean(ShumProp$propWT))

propWEP_SBLsub = as.data.frame(propWEP_SBLsub)
propWEP_SBLsub$propWT = as.numeric(propWEP_SBLsub$propWT)
ChirProp = subset(propWEP_SBLsub, StatArea == "Chirikof")
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(1996, "Chirikof", "Gadus.chalcogrammus", NA, mean(ChirProp$propWT))
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2013, "Chirikof", "Gadus.chalcogrammus", NA, mean(ChirProp$propWT))
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2015, "Chirikof", "Gadus.chalcogrammus", NA, mean(ChirProp$propWT))

propWEP_SBLsub = as.data.frame(propWEP_SBLsub)
propWEP_SBLsub$propWT = as.numeric(propWEP_SBLsub$propWT)
KodProp = subset(propWEP_SBLsub, StatArea == "Kodiak")
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(1996, "Kodiak", "Gadus.chalcogrammus", NA, mean(KodProp$propWT))
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(1999, "Kodiak", "Gadus.chalcogrammus", NA, mean(KodProp$propWT))
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2003, "Kodiak", "Gadus.chalcogrammus", NA, mean(KodProp$propWT))
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2013, "Kodiak", "Gadus.chalcogrammus", NA, mean(KodProp$propWT))
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2015, "Kodiak", "Gadus.chalcogrammus", NA, mean(KodProp$propWT))

propWEP_SBLsub = as.data.frame(propWEP_SBLsub)
propWEP_SBLsub$propWT = as.numeric(propWEP_SBLsub$propWT)
KodProp = subset(propWEP_SBLsub, StatArea == "Yakutat")
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2013, "Yakutat", "Gadus.chalcogrammus", NA, mean(KodProp$propWT))
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2015, "Yakutat", "Gadus.chalcogrammus", NA, mean(KodProp$propWT))

propWEP_SBLsub = as.data.frame(propWEP_SBLsub)
propWEP_SBLsub$propWT = as.numeric(propWEP_SBLsub$propWT)
KodProp = subset(propWEP_SBLsub, StatArea == "Southeastern")
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2013, "Southeastern", "Gadus.chalcogrammus", NA, mean(KodProp$propWT))
propWEP_SBLsub = add_row(propWEP_SBLsub)
propWEP_SBLsub[nrow(propWEP_SBLsub), ] = c(2015, "Southeastern", "Gadus.chalcogrammus", NA, mean(KodProp$propWT))

propWEP_SBLsub = as.data.frame(propWEP_SBLsub)
propWEP_SBLsub$propWT = as.numeric(propWEP_SBLsub$propWT)
propWEP_SBLsub$Year = as.numeric(as.character(propWEP_SBLsub$Year))
...
SBLpredWEP = subset(SBLpredWEP, StatArea != "Yakutat" | Year < 1996 | Year > 2001)
SBLpredWEP = subset(SBLpredWEP, StatArea != "Southeastern" | Year >= 2003)

#########################################################
# Calculate year-specific predation by Sablefish (g; all pollock age classes combined):
SBLpredWEP$Annual_Cmax = as.numeric(as.character(SBLpredWEP$Annual_Cmax))
SBLpredWEP$propWT = as.numeric(as.character(SBLpredWEP$propWT))
...
SBLpredWEP_age$StatArea = as.factor(SBLpredWEP_age$StatArea)
SBLpredWEP_age$StatArea = ordered(SBLpredWEP_age$StatArea, levels = c("Shumagin", "Chirikof", "Kodiak", "Yakutat", "Southeastern"))
...
SBLpredWEP_age_t_max = melt(SBLpredWEP_age, id.vars = c("Year", "StatArea"), measure.vars = c("predWEP_t_max", "predWEP_t_max_Age0", "predWEP_t_max_Age1", "predWEP_t_max_Age2", "predWEP_t_max_Age3plus"), variable.name = "AgeClass", value.name = "MT")
